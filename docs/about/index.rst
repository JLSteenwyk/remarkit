...
**Clip**\ing and **K**\eeping **I**\nformation **T**\rimmer (**remarkit**) was developed as
...
In light of these findings, we developed remarkit, which implements an innovative yet simple
trimming strategy. remarkit achieves this by identifying and retaining phylogenetically-informative
sites rather than identifying and trimming highly divergent ones. Our assessments of remarkit's
...
<performance>`) suggests remarkit is a top-performing software.  
...
remarkit is developed and maintained by `Jacob L. Steenwyk <https://jlsteenwyk.github.io/>`_
...
remarkit has been made possible by other key personnel including `Antonis Rokas
